...
class SchedulersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scheduler" do
    assert_difference("Scheduler.count") do
      post schedulers_url, params: { scheduler: { client_id: @scheduler.client_id, court_id: @scheduler.court_id, date: @scheduler.date, hour: @scheduler.hour, status: @scheduler.status } }
    end
  ...
  test "should update scheduler" do
    patch scheduler_url(@scheduler), params: { scheduler: { client_id: @scheduler.client_id, court_id: @scheduler.court_id, date: @scheduler.date, hour: @scheduler.hour, status: @scheduler.status } }
